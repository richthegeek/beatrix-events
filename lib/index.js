...
(function() {
  ...
  Manager = (function() {
    ...
    Manager.prototype.on = function(event, options, method, cb) {
      return this.ready.then((function(_this) {
        return function() {
          ...
          return _this.connection.createQueue(event, options, cb);
        };
      })(this));
    };

    Manager.prototype.emit = function(event, body, options, cb) {
      options = _.defaults({}, options, {
        routingKey: event
      });
      return this.ready.then((function(_this) {
        return function() {
          return _this.connection.publish(event, body, options, cb);
        };
      })(this));
    };
